...
public class StudentRepository {
	...
	/*public void insertIntoStudentAndCourse() {
		...
		course2.setName("Javascript in 100 steps");
...
/*	public void insetEmployeeAndProject() {
		...
		projectsList.add(ceg);
		projectsList.add(gtt);

		List<Employee> employeesList = new ArrayList<Employee>();
		employeesList.add(prasad);
		employeesList.add(harish);

		ceg.setEmployees(employeesList);
		gtt.setEmployees(employeesList);

		prasad.setProjects(projectsList);
		harish.setProjects(projectsList);
